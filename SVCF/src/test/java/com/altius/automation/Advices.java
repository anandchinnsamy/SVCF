...
public class Advices {
	...
	public void groupadditionhover() throws InterruptedException
	{
		...
		try {
			Actions action =new Actions(d);
			 ...
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[4]/ul/li[1]/a"));
			 action.moveToElement(pw).click().build().perform();	
			 
			logger.info("Hovered on Advices screen successfully");
		} 
		catch (Exception e) {

			logger.error("Not hovered on Advices screen");
	...
	public void chitreport() throws InterruptedException {
       ...
       try
		{
			...
			WebElement designation =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlMisc_chzn\"]/a"));
			Thread.sleep(1000);
			
			designation.click();
			WebElement manager =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlMisc_chzn\"]/div/div/input"));
			Thread.sleep(1000);

			manager.sendKeys("chit");
			Thread.sleep(4000);		
       ...
       // Final status
       String status ="Advice Accepted!!!";
       WebElement stats =d.findElement(By.id("cphMainContent_lblContent"));
       
       if(status.equals(stats.getText()))
       {
    	   logger.info("Advice accepted");
    	   
       }
       else
       {
    	   logger.error("Advice is not accepted");
