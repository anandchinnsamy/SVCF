...
public class Decreeandcourtcostcredit {
	WebDriver d;
...
//		d.manage().window().maximize();
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[3]/ul/li[6]/a"));
				pw.click();
			logger.info("Hovered on credit screen successfully");
		} 
		catch (Exception e) {
	...
	@Test(priority=2)
	public void decreecostcredit() throws InterruptedException
	{
		try
		{
...
// Amount field
		...
		Thread.sleep(5000);
				...
				try
				{
					...
					logger.info("Advocate is successfully selected for debit");
					
				}
				
				catch(Exception e)
				{
					logger.error("Advocate is not successfully selected");
				}
				Thread.sleep(10000);
		...
		// Amount field
				...
				try {
					 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$btnYes"));
						pw.sendKeys("1258");
					logger.info("Amount credited sucessfully");
				} 
				catch (Exception e) {

					logger.error("Amount not credited");
