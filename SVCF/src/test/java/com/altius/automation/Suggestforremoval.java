...
public class Suggestforremoval {
	 WebDriver d;
	...
	public void editauctionhover() throws InterruptedException
	{
		...
		try {
			...
			action.moveToElement(hover).build().perform();
			logger.info("Mouse is successfully hovered on for removal");
		}
		catch (Exception e)
		{
			logger.error(e);
			logger.error("Mouse is not successfully hovered on for removal screen");
		}
		Thread.sleep(2000);
		...
		try {
			...
			WebElement hover = d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[3]/ul/li[5]/ul/li[1]/a"));
			action.moveToElement(hover).build().perform();
			hover.click();
			logger.info("Mouse is successfully clicked on suggest screen");
		}
		catch (Exception e)
		{
			logger.error(e);
			logger.error("Mouse is successfully  not clicked on suggest screen");
		}
		Thread.sleep(2000);
	...
	@Test(priority=2)
	public void suggestforremoval() throws InterruptedException
	{
		try
		{
	 ...
	 Thread.sleep(25000);
		...
		// Commission
				...
				//removal amount
				try {
					 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$txtRemovalAmount"));
						pw.sendKeys("10000");
						
					logger.info("removal amount is  successfully entered");
				} 
				catch (Exception e) 
				{

					logger.error("removal amount is not successfully entered");
				...
				catch (Exception e) 
				{
					...
					logger.error("Reason for removal is not successfully entered");
	...
	//kasar amount
		...
		try {
			 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$txtMonthlyIncome"));
				pw.sendKeys("2000");
		...
		// removal date
		try {
			 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$txtDateofRemoval"));
				pw.sendKeys("14032019");
				
			logger.info("removal date  is  successfully entered");
		} 
		catch (Exception e) 
		{

			logger.error("removal date is not successfully entered");
		...
		// First notice date
				try {
					 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$txt1stNoticeDate"));
						pw.sendKeys("14032019");				
					logger.info("First notice date is successfully entered");
				} 
				catch (Exception e) 
				{

					logger.error("First notice date is not entered");

				}
				
				// Second notice date
				try {
					 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$txt2ndNoticeDate"));
						pw.sendKeys("14032019");				
					logger.info("Second notice date is successfully entered");
				} 
				catch (Exception e) 
				{

					logger.error("Second notice date is not entered");
		...
		try {
			...
			logger.info("Substitute button is successfully clicked");
		} 
		catch (Exception e) 
		{

			logger.error("Substitute button is not clicked");
		...
		try {
			...
			logger.info("Memeber is successfully trnsfered");
			 ...
			 else
			 {
				 ...
				 logger.info("Member is not removaled");
			 }
		    } 
		catch (Exception e) 
		{

			logger.error("Member is not removaled");
