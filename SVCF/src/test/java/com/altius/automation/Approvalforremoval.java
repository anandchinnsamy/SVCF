...
public class Approvalforremoval {
	WebDriver d;
...
public void editauctionhover() throws InterruptedException
{
	...
	try {
		...
		action.moveToElement(hover).build().perform();
		logger.info("Mouse is successfully hovered on screen for removal");
	}
	catch (Exception e)
	{
		logger.error(e);
		logger.error("Mouse is not successfully hovered on screen for removal");
	}
	Thread.sleep(2000);
	...
	try {
		...
		WebElement hover = d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[3]/ul/li[5]/ul/li[2]/a"));
		action.moveToElement(hover).build().perform();
		hover.click();
		logger.info("Mouse is successfully clicked on removal approval screen");
	}
	catch (Exception e)
	{
		logger.error(e);
		logger.error("Mouse is successfully  not clicked on removal approval screen");
	}
	Thread.sleep(2000);
