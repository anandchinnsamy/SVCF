...
public class Foremansubstituedpayment {
	WebDriver d;
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[2]/ul/li[3]/a"));
				pw.click();
			logger.info("Hovered on foreman substitute payment  screen successfully");
		} catch (Exception e) {

			logger.error("Not hovered on foreman substitute payment  screen");
