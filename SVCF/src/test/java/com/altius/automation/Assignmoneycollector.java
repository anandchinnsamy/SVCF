...
public class Assignmoneycollector extends Approvalfornewgroup {
//	WebDriver d;
	...
	public void trnsferaddtion() throws InterruptedException {
		...
		try {
			...
			WebElement hover = d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[4]/ul/li/ul/li[3]/a"));
			action.moveToElement(hover).build().perform();
			hover.click();
	...
	@Test(priority = 2)
	public void assignmoneycollector() throws InterruptedException {
		
		// Group ID
		try {

			WebElement designation = d.findElement(By.xpath("//*[@id=\"cphMainContent_DD_Gid_chzn\"]/a"));
			Thread.sleep(1000);

			designation.click();
			WebElement manager = d.findElement(By.xpath("//*[@id=\"cphMainContent_DD_Gid_chzn\"]/div/div/input"));
			Thread.sleep(1000);
			...
			logger.info("Group ID is successfully selected");
			Thread.sleep(5000);

		}

		catch (Exception e) {
			logger.error("Group ID is not successfully selected");
		}
		
		// money collector list
		
		try {
			Thread.sleep(2000);
			WebElement designation = d.findElement(By.xpath("//*[@id=\"cphMainContent_DD_MCList_chzn\"]/a"));
			Thread.sleep(1000);

			designation.click();
			WebElement manager = d.findElement(By.xpath("//*[@id=\"cphMainContent_DD_MCList_chzn\"]/div/div/input"));
			Thread.sleep(1000);

			manager.sendKeys("Veerabagu");
			Thread.sleep(3000);
			manager.sendKeys(Keys.TAB);
			logger.info("Money collector list is successfully selected");
		...
		{
			logger.error(e);
			logger.error("Money collector list is not successfully selected");
		}

		
		// Update button 
		d.findElement(By.name("ctl00$cphMainContent$BtnUpdate")).click();
}
