...
public class Otherbranchpaymenttemporary {
	WebDriver d;
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[2]/ul/li[2]/a"));
				pw.click();
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[2]/ul/li[2]/ul/li[2]/a"));
				pw.click();
			logger.info("Hovered on other branch payment  screen successfully");
		} catch (Exception e) {

			logger.error("Not hovered on other branch payment  screen");
	...
	public void payment() throws InterruptedException
	{
		...
		//	designation.selectByIndex(2);
			logger.info("MLT is successfully selected");
			
		}
		
		catch(Exception e)
		{
			logger.error("MLT is not successfully selected");
		}
	   ...
	   Thread.sleep(10000);
		...
		try {
			 WebElement pw =d.findElement(By.id("cphMainContent_GR_Type_1"));
				pw.click();
		...
		try
		{
			...
			manager.sendKeys("tambaram");
			Thread.sleep(1000);

			manager.sendKeys(Keys.TAB);
			
			logger.info("Branch is successfully selected");
		}
