...
//		d.manage().window().maximize();
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[3]/ul/li[1]/a"));
				pw.click();
			logger.info("Hovered on filing Voucher successfully");
		} 
		catch (Exception e) {
	...
	@Test(priority=2)
	public void Filingfees() throws InterruptedException
	{
		try
		{
	   ...
	   Thread.sleep(6000);
		...
		try
		{
			...
			WebElement designation =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlCredit_chzn\"]/a"));
			Thread.sleep(1000);
			
			designation.click();
			WebElement manager =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlCredit_chzn\"]/div/div/input"));
			Thread.sleep(1000);
