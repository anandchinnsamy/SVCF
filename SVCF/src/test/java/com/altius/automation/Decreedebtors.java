...
public class Decreedebtors {
	...
	public void paymenthover() throws InterruptedException
	{
		...
		try
		{
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[5]/ul/li[3]/a"));
				pw.click();
			logger.info("Hovered on decree decorts screen successfully");
		} 
		catch (Exception e)
       {

			logger.error("Not hovered on decree decorts screen");
		...
		public void loan() throws InterruptedException
		{
			...
			//	designation.selectByIndex(2);
				logger.info("Court cost is successfully selected");
				
			}
			
		catch (Exception e) 
			{
			logger.error("Court cost is not successfully selected");
		...
		try {
			...
			WebElement designation = d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlMember_chzn\"]/a"));
			Thread.sleep(1000);

			designation.click();
			Thread.sleep(1000);

			WebElement manager = d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlMember_chzn\"]/div/div/input"));
			Thread.sleep(1000);

			manager.sendKeys("fees");
			Thread.sleep(2000);

			manager.sendKeys(Keys.TAB);

			// designation.selectByIndex(2);
			logger.info("advocate fees is successfully selected");

		}

		catch (Exception e) 
		{
			logger.error("advocate fees is not successfully selected");
		}
		...
		catch (Exception e) 
		{
			...
			logger.error("Decree decotrs button is not clicked");
