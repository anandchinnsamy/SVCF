...
public class Fixeddepositrelease {
	WebDriver d;
...
//		d.manage().window().maximize();
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[3]/ul/li[2]/a"));
				pw.click();
			logger.info("Hovered on fixed deposit voucher successfully");
		} 
		catch (Exception e) {

			logger.error("Not hovered on fixed deposit voucher");
	...
	@Test(priority=2)
	public void FDrelease() throws InterruptedException
	{
		try
		{
	   ...
	   Thread.sleep(6000);
		...
		try
		{
			...
			designation.sendKeys("2589");
			
			logger.info("FDR num is successfully entered");
			
		}
		
		catch(Exception e)
		{
			logger.error("FDR num is not entered");
		}
		...
		// Debit head
				try
				{
					...
					WebElement designation =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlBranchid_chzn\"]/a"));
					Thread.sleep(1000);
					
					designation.click();
					WebElement manager =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlBranchid_chzn\"]/div/div/input"));
					Thread.sleep(1000);

					manager.sendKeys("pallathur");
					Thread.sleep(1000);

					manager.sendKeys(Keys.TAB);
					
					
					logger.info("Debit head is successfully selected");
					
				}
				
				catch(Exception e)
				{
					logger.error("Debit head  is not successfully selected");
				}
