...
public class Decreeandcoutcostdebit {
	WebDriver d;
...
//		d.manage().window().maximize();
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[3]/ul/li[5]/a"));
				pw.click();
	...
	@Test(priority=2)
	public void decreecostdebit() throws InterruptedException
	{
		try
		{
		...
		// Amount field
				...
				try {
					 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$btnYes"));
						pw.sendKeys("1258");
					logger.info("Amount debited sucessfully");
				} 
				catch (Exception e) {

					logger.error("Amount not debited");
