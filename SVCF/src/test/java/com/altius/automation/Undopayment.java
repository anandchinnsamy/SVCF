...
public class Undopayment {
	WebDriver d;
	Logger logger = Logger.getLogger(Undopayment.class);
	String amount = "1250";
...
// Undo payment
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[2]/ul/li[5]/a"));
				pw.click();
			logger.info("Hovered on Undo payment  screen successfully");
		} catch (Exception e) {

			logger.error("Not hovered on Undo payment  screen");
		...
		try
		{
			...
			WebElement designation =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlGroup_chzn\"]/a"));
			Thread.sleep(1000);
			
			designation.click();
			WebElement manager =d.findElement(By.xpath("//*[@id=\"cphMainContent_ddlGroup_chzn\"]/div/div/input"));
			Thread.sleep(1000);
	   ...
	   Thread.sleep(8000);
		...
		try
		{
			...
			WebElement designation =d.findElement(By.name("ctl00$cphMainContent$Button3"));
			Thread.sleep(1000);
			designation.click();
			
			
			logger.info("Undo button is successfully selected");
		}
		
		catch(Exception e)
		{
			logger.error("Undo button is not successfully selected");
		...
		// Undo button
				try
				{
					...
					logger.info("Payment is successfully deleted");
				}
				
				catch(Exception e)
				{
					logger.error("Payment is not successfully deleted");
