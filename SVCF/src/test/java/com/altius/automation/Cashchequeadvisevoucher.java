...
public class Cashchequeadvisevoucher {
	WebDriver d;
...
//		d.manage().window().maximize();
	...
	public void paymenthover()
	{
		...
		try {
			 WebElement pw =d.findElement(By.xpath("//*[@id=\"smoothmenu_h\"]/ul/li[2]/ul/li[3]/ul/li[7]/a"));
				pw.click();
	...
	@Test(priority=2)
	public void cashchequeadvisorvoucher() throws InterruptedException
	{
		try
		{
...
// Amount field
		...
		// Cheque field
				...
				try {
					 WebElement pw =d.findElement(By.name("ctl00$cphMainContent$crbtnAdd"));
						pw.click();
					logger.info("Credit transaction successfully added");
				} 
				catch (Exception e) {
				...
				try
				{
					...
					logger.info("Bank is successfully selected for debit trnsactions");
		...
		// Amount field
				...
				try {
					...
					logger.error("Credit transaction not added");
